// ======================================================================
// Lab07.v generated from TopDesign.cysch
// 11/02/2023 at 13:18
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_11 or Net_12 or Net_4)
        begin
            case (Net_4)
	...
	wire [0:0] tmpOE__PSOC_Pin_net;
	wire [0:0] tmpFB_0__PSOC_Pin_net;
	wire [0:0] tmpIO_0__PSOC_Pin_net;
	wire [0:0] tmpINTERRUPT_0__PSOC_Pin_net;
	electrical [0:0] tmpSIOVREF__PSOC_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("1e3ac9a3-ee44-42a7-ad84-7e2934832b17"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		PSOC_Pin
		 (.oe(tmpOE__PSOC_Pin_net),
		  .y({Net_15}),
		  .fb({tmpFB_0__PSOC_Pin_net[0:0]}),
		  .io({tmpIO_0__PSOC_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__PSOC_Pin_net),
		  .interrupt({tmpINTERRUPT_0__PSOC_Pin_net[0:0]}),
		  .annotation({Net_19}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PSOC_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_20)
    begin
        cy_tff_1 <= Net_13^Net_12;
    end
    assign Net_12 = cy_tff_1;
    // -- TFF End --
    ...
    // -- TFF Start --
    reg  cy_tff_2;
    always @(posedge Net_21)
    begin
        cy_tff_2 <= Net_22^Net_11;
    end
    assign Net_11 = cy_tff_2;
    // -- TFF End --
	...
	cy_clock_v1_0
		#(.id("967843b1-bbdd-4a40-9171-ec08fad9d268"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000000"),
		  .is_direct(0),
