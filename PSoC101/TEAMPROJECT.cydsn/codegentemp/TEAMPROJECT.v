...
module ADC_SAR_SEQ_P4_v2_50_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("8b84785a-2f63-429e-9fe9-b20f3985de78/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("8b84785a-2f63-429e-9fe9-b20f3985de78/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("48e4a0c6-b7dc-4ad6-aeeb-4245ebfb9025/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("e1dd6330-c415-42d6-92dc-a3669d9c5a50"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1204819277108.43"),
		  .is_direct(0),
		  .is_digital(1))
		Sound1
		 (.clock_out(Net_74));
	...
	cy_clock_v1_0
		#(.id("39f68514-b5c3-41b7-9a58-74889e341d0e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1612903225806.45"),
		  .is_direct(0),
		  .is_digital(1))
		Sound2
		 (.clock_out(Net_61));
	...
	cy_clock_v1_0
		#(.id("72e502ec-0471-4658-a05f-d3c9e7b250c9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1984126984126.98"),
		  .is_direct(0),
		  .is_digital(1))
		Sound3
		 (.clock_out(Net_64));
	...
	cy_clock_v1_0
		#(.id("1d470fe4-f02d-4ba4-b8bb-cdd27896cc09"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("2439024390243.9"),
		  .is_direct(0),
		  .is_digital(1))
		Sound4
		 (.clock_out(Net_67));
	...
	cy_psoc3_pins_v1_10
		#(.id("70023dd6-7a2c-4e60-b7ac-14ebb0c45586"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_118 or Net_72 or Net_56)
        begin
            case (Net_56)
                1'b0 :  tmp__mux_1_reg = Net_118;
                1'b1 :  tmp__mux_1_reg = Net_72;
            endcase
        end
        assign Net_47 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_119 or Net_71 or Net_249)
        begin
            case (Net_249)
                1'b0 :  tmp__mux_2_reg = Net_119;
                1'b1 :  tmp__mux_2_reg = Net_71;
            endcase
        end
        assign Net_48 = tmp__mux_2_reg;
    end
    // -- Mux end --
    ...
    begin : mux_3
        reg  tmp__mux_3_reg;
        always @(Net_31 or Net_70 or Net_58)
        begin
            case (Net_58)
                1'b0 :  tmp__mux_3_reg = Net_31;
                1'b1 :  tmp__mux_3_reg = Net_70;
            endcase
        end
        assign Net_51 = tmp__mux_3_reg;
    end
    // -- Mux end --
    ...
    begin : mux_4
        reg  tmp__mux_4_reg;
        always @(Net_37 or Net_69 or Net_256)
        begin
            case (Net_256)
                1'b0 :  tmp__mux_4_reg = Net_37;
                1'b1 :  tmp__mux_4_reg = Net_69;
            endcase
        end
        assign Net_222 = tmp__mux_4_reg;
    end
    // -- Mux end --
    ...
    assign Net_117 = Net_47 | Net_48 | Net_51 | Net_222;
	...
	cy_psoc3_pins_v1_10
		#(.id("ba9f0439-7278-4ceb-8475-1f3132a6ba6e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b300df94-98d9-4112-b890-1df381c0656e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__But4_net;
	wire [0:0] tmpIO_0__But4_net;
	wire [0:0] tmpINTERRUPT_0__But4_net;
	electrical [0:0] tmpSIOVREF__But4_net;

	cy_psoc3_pins_v1_10
		#(.id("0e81c71c-f358-4281-8580-6520fc1f9870"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		But4
		 (.oe(tmpOE__But4_net),
		  .y({1'b0}),
		  .fb({Net_123}),
		  .io({tmpIO_0__But4_net[0:0]}),
		  .siovref(tmpSIOVREF__But4_net),
		  .interrupt({tmpINTERRUPT_0__But4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__But4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_250 = ~Net_121;


    assign Net_254 = ~Net_120;


    assign Net_244 = ~Net_122;


    assign Net_124 = ~Net_123;

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_61)
    begin
        cy_tff_1 <= Net_60^Net_71;
    end
    assign Net_71 = cy_tff_1;
    // -- TFF End --
    ...
    begin
        cy_tff_2 <= Net_63^Net_70;
    end
    assign Net_70 = cy_tff_2;
    // -- TFF End --

    // -- TFF Start --
    reg  cy_tff_3;
    always @(posedge Net_67)
    begin
        cy_tff_3 <= Net_66^Net_69;
    end
    assign Net_69 = cy_tff_3;
    // -- TFF End --

    // -- TFF Start --
    reg  cy_tff_4;
    always @(posedge Net_74)
    begin
        cy_tff_4 <= Net_73^Net_72;
    end
    assign Net_72 = cy_tff_4;
    // -- TFF End --
	...
	cy_psoc3_pins_v1_10
		#(.id("bb2f11ab-a2b4-4ebe-99e6-4dd1e87e68f0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8a0504b8-103a-412b-86bc-1894294eea57"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f6070f95-03cb-4146-9ec0-841ae5ab7c4e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5c9123dc-b762-43d0-9b78-fd21898fed7d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 MasterReg (
        ...
        .control_7(Net_129),
        .reset(1'b0));
    defparam MasterReg.Bit0Mode = 0;
    defparam MasterReg.Bit1Mode = 0;
    defparam MasterReg.Bit2Mode = 0;
    defparam MasterReg.Bit3Mode = 0;
    defparam MasterReg.Bit4Mode = 0;
    defparam MasterReg.Bit5Mode = 0;
    defparam MasterReg.Bit6Mode = 0;
    defparam MasterReg.Bit7Mode = 0;
    defparam MasterReg.BitValue = 0;
    defparam MasterReg.BusDisplay = 0;
    defparam MasterReg.ExtrReset = 0;
    defparam MasterReg.NumOutputs = 4;


    assign Net_256 = Net_124 | Net_230;


    assign Net_58 = Net_244 | Net_234;


    assign Net_249 = Net_254 | Net_233;


    assign Net_56 = Net_250 | Net_258;
