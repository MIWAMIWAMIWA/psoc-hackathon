...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT14), 0x00000021u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT15), 0x00000011u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C00), 0x800070F3u);

	/* CYDEV_CLK_DIVIDER_A01 Starting address: CYDEV_CLK_DIVIDER_A01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A01), 0x80009735u);

	/* CYDEV_CLK_DIVIDER_B01 Starting address: CYDEV_CLK_DIVIDER_B01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B01), 0x8000BA02u);

	/* CYDEV_CLK_DIVIDER_C01 Starting address: CYDEV_CLK_DIVIDER_C01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C01), 0x8000E4A8u);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x51030000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG8), 0x26000000u);
